        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {!! Form::open(['route' => ['resort.photo.store', $resort->id], 'method' => 'POST']) !!}
                    <div class="row">
    ...
    <div class="box">
        <div class="box-header with-border">
            <div class="box-header-content">
                <h4 class="box-title">Photo Galleries: {{ $resort->name }}</h4>
            </div>
            <div class="action">
        ...
        <div class="box-body">
            <div class="row">
                @if($resort->galleries->isNotEmpty())
                        ...
                        <div class="col-lg-3">
                            <div class="photo">
                                ...
                                <div class="photo-action">
                                    {!! Form::open(['route' => ['resort.photo.delete',['id' => $gallery->resort_id, 'photo_id' => $gallery->id]], 'method' => 'DELETE']) !!}
