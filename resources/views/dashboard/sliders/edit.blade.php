    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="box">
                ...
                {!! Form::open(['route' => ['slider.update', $slider->id], 'method' => 'PUT']) !!}
                <div class="box-body">
                    <div class="form-group">
                        <label for="">Title</label>
                        <input type="text" name="name" class="form-control" value="{{ $slider->title }}" placeholder="Enter name">
                                ...
                                <div class="img-upload">
                                    <div class="img-prev">
                                        <div class="img-content">
                                            <img src="{{ asset($slider->image) }}" alt="" id="imgPrev">
