    ...
    <div class="box">
        <div class="box-header with-border">
            <div class="box-header-content">
                <h5 class="box-title">Create Package</h5>
            </div>
            <div class="action">
        ...
        <div class="box-body">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number" step="1" name="min_member" placeholder="Min Member" class="form-control">
                        <span class="text-danger"></span>
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <textarea name="short_description"  rows="5" class="form-control" placeholder="write short description about the package"></textarea>
                <span class="text-danger"></span>
            </div>
            <div class="form-group">
                <label for="">Description</label>
                <textarea name="description" class="form-control description-summernote"></textarea>
                <span class="text-danger"></span>
            </div>
            <div class="row">
