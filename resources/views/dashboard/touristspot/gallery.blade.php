        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {!! Form::open(['route' => ['tourist.spot.store.gallery', $tourist_spot->id], 'method' => 'POST']) !!}
                    <div class="row">
    ...
    <div class="box">
        <div class="box-header with-border">
            <div class="box-header-content">
                <h4 class="box-title">Photo Galleries: {{ $tourist_spot->name }}</h4>
            </div>
            <div class="action">
                <button class="btn btn-sm btn-light" data-toggle="modal" data-target="#addGallery"><i class="fas fa-plus"></i> Photo</button>
            </div>
        </div>
        <div class="box-body">
            <div class="row">
                @if($tourist_spot->galleries->isNotEmpty())
                    @foreach($tourist_spot->galleries as $gallery)
                        <div class="col-lg-3">
                            <div class="photo">
                                ...
                                <div class="photo-action">
                                    ...
                                    {{--                                    </button>--}}
                                    {!! Form::open(['route' => ['tourist.spot.delete.gallery',['tourist_spot_id' => $gallery->tourist_spot_id, 'gallery_id' => $gallery->id]], 'method' => 'DELETE']) !!}
