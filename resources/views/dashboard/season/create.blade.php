            ...
            <div class="box">
                <div class="box-header with-border">
                    <div class="box-header-content">
                        <h4 class="box-title">Create new Season</h4>
                    </div>
                    <div class="action">
                        <a href="{{ route('season.list') }}" class="btn btn-light">Season list</a>
                    </div>
                </div>
                {!! Form::open(['route' => 'season.store', 'method' => 'POST']) !!}
                <div class="box-body">
                    {{-- @if($user_type === 'system_user')
                        <div class="form-group">
                            <label for="">Resort</label>
                            {!! Form::select('resort[]', formSelectOptions($resorts), null, ['class' => 'form-control multiple-select2', 'multiple']) !!}
