<div class="box">
    ...
    {!! Form::open(['route' => 'setting.booking.store', 'method' => 'POST']) !!}
    <div class="box-body">
        <div class="form-group">
            <div class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input" name="weekend_price" value="1" id="weekend_price">
                <label for="weekend_price" class="custom-control-label">Active Weekend Price on Booking.</label>
            </div>
        </div>
        <div class="form-group">
            <div class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input" name="holiday_price" value="1" id="holiday_price">
                <label for="holiday_price" class="custom-control-label">Active Holiday Price on Booking.</label>
            </div>
        </div>
        <div class="form-group">
            <div class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input" name="is_vat" value="1" id="is_vat">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="vat_amount" placeholder="Vat amount" id="vat_amount" class="form-control" disabled>
    ...
    'inclusive' => 'Inclusive',
    'exclusive' => 'Exclusive',
], null, ['class' => 'form-control', 'disabled', 'id' => 'vat_type', 'placeholder' => 'Select  vat type']) !!}
                        <span class="text-danger"></span>
                    </div>
                </div>
            </div>
