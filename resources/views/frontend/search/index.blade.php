            ...
            <div class="row">
                    ...
                    <div class="search-filter">
                        ...
                        <div class="form-group has-options">
                            ...
                            <div class="form-input-group">
                                ...
                                <input type="text" name="destination" id="destination" autocomplete="off" class="form-control" placeholder="Resort, Tourist Spot, City" value="{{ $search_data['destination'] }}" required>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-input-group">
                                ...
                                <input type="text" name="check_in" id="checkIn" autocomplete="off"  class="form-control check-in-datepicker datepicker" placeholder="dd-mm-yyyy" value="{{ Session::get('check_in_date') }}">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="form-input-group">
                                <i class="fas fa-calendar"></i>
                                <input type="text" name="check_out" autocomplete="off" id="checkOut" class="form-control check-out-datepicker datepicker" placeholder="dd-mm-yyyy" value="{{ Session::get('check_out_date') }}">
                            </div>
                        </div>
                        <div class="form-group">
                ...
                <div class="col-md-9">
                    <div class="search-result">
                        <div class="search-result-header mb-15">
                            <h4>Result for {{ Str::ucfirst($search_data['destination']) }}</h4>
                        </div>
